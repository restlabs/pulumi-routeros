PROJECT_NAME := Pulumi routeros Resource Provider

PACK             := routeros
PACKDIR          := sdk
PROJECT          := github.com/restlabs/pulumi-routeros
NODE_MODULE_NAME := @restlabs/routeros
NUGET_PKG_NAME   := Restlabs.routeros
